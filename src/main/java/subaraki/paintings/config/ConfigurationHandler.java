...
public class ConfigurationHandler {
    ...
    private void loadSettings(Configuration config) {
        config.addCustomCategoryComment("Painting Mode", "The layout pattern of your art texture. "
        		+ "\n Built-in patterns include gibea, sphax, insane, tinypics, mediumpics, new_insane, and massive. "
        		+ "\n Use of a custom pattern is possible by including a JSON file in your ");
